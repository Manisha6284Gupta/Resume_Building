...
import { buttonStyles, inputStyles } from '../assets/dummystyle'
import { EyeOff, Eye } from 'lucide-react'
import { useRef } from 'react'
import { photoSelectorStyles, titleInputStyles } from '../assets/dummystyle';
import { Camera, Edit, Trash2, Check } from 'lucide-react';
  ...
  return (
    <div className={styles.wrapper}>
        ...
        <div className={styles.inputContainer(isFocused)}>
            <input type={type === 'password' ? (showPassword ? 
                'text' : 'password'): type} 
