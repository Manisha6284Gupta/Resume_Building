...
// import { FiMail as LuMail, FiPhone as LuPhone, FiGithub as LuGithub,  FiGlobe as LuGlobe } from "react-icons";
...
import React, { useEffect, useRef, useState } from "react";
import { FiMail, FiPhone, FiGithub, FiGlobe, FiExternalLink } from "react-icons/fi";
import { RiLinkedinLine } from "react-icons/ri";
import {
  EducationInfo,
  WorkExperience,
...
const DEFAULT_THEME = ["#ffffff", "#0d47a1", "#1e88e5", "#64b5f6", "#bbdefb"];
const sectionTitleClass = "text-sm font-bold uppercase mb-1 text-gray-900";
