...
//   return (
//     <div style={{ backgroundColor: theme[0], color: theme[1], padding: "2rem", fontFamily: "sans-serif" }}>
...
//         <p><FiGithub /> {contact?.github}</p>
//         <p><FiGlobe /> {contact?.website}</p>
//         <p><RiLinkedinLine /> {contact?.linkedin}</p>
//       </section>
...
const TemplateOne = ({ data = {}, theme = ["#ffffff", "#000000"] }) => {
  const {
    contact = {},
    education = [],
    experience = [],
